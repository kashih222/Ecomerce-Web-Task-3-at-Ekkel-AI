          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="hero-content flex flex-col gap-6 md:gap-10 text-center md:text-left">
              ...
              <p className="text-xl md:text-2xl major-mono leading-relaxed">
                Where style meets comfort. Our mission is to deliver
                high-quality products that inspire confidence and bring joy to
                your everyday life. Explore our curated selections made with
                passion and care.
              </p>
            </div>

            <div className="hero-img relative flex justify-center md:justify-end">
              <div className="absolute bg-gray-300 rounded-lg shadow-2xl z-0 w-50 h-50 sm:w-65 sm:h-65 md:w-82.5 md:h-82.5 lg:w-125 lg:h-125 xl:w-140 xl:h-115 -top-6 md:-top-10 right-6 md:right-20 " ></div>
